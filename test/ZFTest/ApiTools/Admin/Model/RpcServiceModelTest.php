...
class RpcServiceModelTest extends TestCase
{
    ...
    public function testCanUpdateContentNegotiationWhitelists()
    {
        ...
        $this->assertEquals(array(
            'application/xml',
            'application/*+xml',
        ), $config['api-tools-content-negotiation']['accept-whitelist']['FooConf\Rpc\HelloWorld\Controller']);
        $this->assertEquals(array(
            'application/xml',
        ), $config['api-tools-content-negotiation']['content-type-whitelist']['FooConf\Rpc\HelloWorld\Controller']);
    }
