...
class AuthenticationEntityTest extends TestCase
{
    ...
    {
        $entity = new AuthenticationEntity(AuthenticationEntity::TYPE_BASIC, 'laminascon', array(
    ...
    {
        $entity = new AuthenticationEntity(AuthenticationEntity::TYPE_DIGEST, 'laminascon', array(
            'htpasswd'       => __DIR__ . '/htpasswd',
            'htdigest'       => __DIR__ . '/htdigest',
            'nonce_timeout'  => 3600,
            'digest_domains' => '/api',
