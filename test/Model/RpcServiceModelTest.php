...
class RpcServiceModelTest extends TestCase
{
    ...
    public function testCanUpdateContentNegotiationSelector()
    {
        ...
        $config = include $configFile;
        $this->assertEquals('MyCustomSelector', $config['api-tools-content-negotiation']['controllers']['FooConf\Rpc\HelloWorld\Controller']);
    }
    ...
    public function testDeleteServiceRemovesExpectedConfigurationElements()
    {
        ...
        $this->assertArrayNotHasKey($result->controllerServiceName, $config['api-tools-content-negotiation']['controllers']);
        $this->assertArrayNotHasKey($result->controllerServiceName, $config['api-tools-content-negotiation']['accept_whitelist']);
        $this->assertArrayNotHasKey($result->controllerServiceName, $config['api-tools-content-negotiation']['content_type_whitelist']);
