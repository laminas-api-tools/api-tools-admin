...
return array(
    'service_manager' => array(
        'invokables' => array(
            'Laminas\ApiTools\Admin\Listener\CryptFilterListener' => 'Laminas\ApiTools\Admin\Listener\CryptFilterListener',
        ),
        'factories' => array(
    ...
    'controllers' => array(
        ...
        'invokables' => array(
            ...
            'Laminas\ApiTools\Admin\Controller\Strategy' => 'Laminas\ApiTools\Admin\Controller\StrategyController',
                        ...
                        'child_routes' => array(
                            'dashboard' => array(
                                ...
                                'options' => array(
                                    'route' => '/dashboard',
                                    'defaults' => array(
                                        'controller' => 'Laminas\ApiTools\Admin\Controller\Dashboard',
                                        'action'     => 'dashboard',
                                    ),
                                ),
                            ),
                            'settings-dashboard' => array(
                                ...
                                'options' => array(
                                    ...
                                    'defaults' => array(
                                        'controller' => 'Laminas\ApiTools\Admin\Controller\SettingsDashboard',
                            ...
                            'strategy' => array(
                                ...
                                'options' => array(
                                    ...
                                    'defaults' => array(
                                        'controller' => 'Laminas\ApiTools\Admin\Controller\Strategy',
                                        'action'     => 'exists',
                                    ),
                                ),
                            ),
                                ...
                                'child_routes' => array(
                                    ...
                                    'db-autodiscovery' => array(
                                        ...
                                        'options' => array(
                                            ...
                                            'defaults' => array(
                                                'controller' => 'Laminas\ApiTools\Admin\Controller\DbAutodiscovery',
                                                'action' => 'discover',
                                            ),
                                        ),
                                    ),
                            ...
                            'doctrine-adapter' => array(
                                ...
                                'options' => array(
                                    ...
                                    'defaults' => array(
                                        'controller' => 'Laminas\ApiTools\Admin\Controller\DoctrineAdapter',
                                    ),
                                ),
                            ),
                            ...
                            'package' => array(
                                ...
                                'options' => array(
                                    'route' => '/package',
                                    'defaults' => array(
                                        'controller' => 'Laminas\ApiTools\Admin\Controller\Package',
                                        'action'     => 'index',
                                    ),
                                ),
                            ),
                            'authentication-type' => array(
                                ...
                                'options' => array(
                                    'route' => '/auth-type',
                                    'defaults' => array(
                                        'controller' => 'Laminas\ApiTools\Admin\Controller\AuthenticationType',
                                        'action'     => 'authType',
                                    ),
                                ),
                            ),
    ...
    'api-tools-content-negotiation' => array(
        ...
        'accept_whitelist' => array(
            ...
            'Laminas\ApiTools\Admin\Controller\Dashboard' => array(
                'application/json',
                'application/*+json',
            ),
            ...
            'Laminas\ApiTools\Admin\Controller\DbAutodiscovery' => array(
                'application/json',
                'application/*+json',
            ),
            'Laminas\ApiTools\Admin\Controller\DoctrineAdapter' => array(
                'application/json',
                'application/*+json',
            ),
            ...
            'Laminas\ApiTools\Admin\Controller\SettingsDashboard' => array(
                'application/json',
                'application/*+json',
            ),
            ...
            'Laminas\ApiTools\Admin\Controller\Strategy' => array(
                'application/json',
                'application/*+json',
            ),
    ...
    'api-tools-hal' => array(
        'metadata_map' => array(
            ...
            'Laminas\ApiTools\Admin\Model\DoctrineAdapterEntity' => array(
                'hydrator'        => 'ArraySerializable',
                'route_identifier_name' => 'adapter_name',
                'entity_identifier_name' => 'adapter_name',
    ...
    'api-tools-rpc' => array(
        ...
        'Laminas\ApiTools\Admin\Controller\AuthenticationType' => array(
        ...
        'Laminas\ApiTools\Admin\Controller\Package' => array(
    ...
    'filter_metadata' => array(
        ...
        'Laminas\Filter\DateTimeFormatter' => array(
            'format' => 'string',
        ),
        ...
        'Laminas\Filter\ToInt' => array(),
        'Laminas\Filter\ToNull' => array(
            'type' => 'int|string',
        ),
    ...
    'validator_metadata' => array(
        ...
        'Laminas\I18n\Validator\IsFloat' => array(
            'locale' => 'string',
        ),
        'Laminas\I18n\Validator\IsInt' => array(
            'locale' => 'string',
        ),
