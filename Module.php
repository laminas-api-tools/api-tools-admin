...
class Module
{
    ...
    public function getAutoloaderConfig()
    {
        return array(
            'Laminas\Loader\StandardAutoloader' => array(
                'namespaces' => array(
                    __NAMESPACE__ => __DIR__ . '/src/Laminas/ApiTools/Admin/',
                ),
            ),
        );
    }
    ...
    public function injectServiceCollectionRelationalLinks($entity, $e)
    {
        ...
        $links->add(Link::factory(array(
            'rel' => 'self',
            'route' => array(
                'name' => sprintf('api-tools-admin/api/module/%s-service', $type),
                'params' => array(
                    'name' => $module,
        ...
        $links->add(Link::factory(array(
            'rel' => 'input_filter',
            'route' => array(
                'name' => sprintf('api-tools-admin/api/module/%s-service/%s_input_filter', $type, $type),
                'params' => array(
                    'name' => $module,
                    'controller_service_name' => $service,
                ),
