...
use Laminas\ApiTools\Configuration\Module;
...
EOD;
    ...
    public function updateModule($module)
    {
        ...
        $replacement = preg_replace(
            ...
            "use Laminas\ApiTools\ApiToolsModuleInterface;\n\nclass $1 implements ApiToolsModuleInterface\n{",
            $content
        );
        ...
        if ($replacement === $content) {
            $replacement = preg_replace(
                '/implements\s/',
                'implements Laminas\ApiTools\ApiToolsModuleInterface,',
                $content
            );
        }
     ...
     *
     * @param  ApiToolsModuleInterface $module
     * @return int
     */
    protected function getModuleDefaultVersion(ApiToolsModuleInterface $module)
    {
     ...
     * @return array
     */
    protected function getVersionsByModule($moduleName, ApiToolsModuleInterface $module)
    {
